        ...
        <>
            {/* <div style={{"backgroundColor":"black", "padding":"2% 0"}}>
                <div>
                    ...
                    <span style={{"verticalAlign":"middle"}}>
                        <button style={{"margin":"0 5%", "color":"red", "padding":"1%", "fontSize":"120%", "backgroundColor":"transparent", "color":"white", "border":"1px solid white", "borderRadius":"5px"}} onClick={()=>navigate("/profile")}>PROFILE</button>
                        <button style={{"color":"red", "padding":"1%", "fontSize":"120%", "backgroundColor":"transparent", "color":"white", "border":"1px solid white", "borderRadius":"5px"}} onClick={()=>navigate("/donate_product")}>DONATE</button>
                    </span>
                </div>
            </div> */}
        ...
        <MDBContainer fluid>
          ...
          <MDBCollapse navbar open={openNavNoTogglerThird}>
            ...
            <MDBInputGroup tag="form" className='d-flex w-auto mb-3'>
              ...
              <MDBBtn outline onClick={()=>navigate("/donate_product")}>Donate now</MDBBtn>
            </MDBInputGroup>
          </MDBCollapse>
        </MDBContainer>
      </MDBNavbar>
